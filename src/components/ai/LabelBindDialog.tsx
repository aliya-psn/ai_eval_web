            ...
            <div className="space-y-1">
              ...
              {selectableFilteredLabels.length > 0 && (
                <div className="flex items-center gap-2 px-1 pb-1 text-xs text-muted-foreground">
                  ...
                  >
                    {`全选 ${selectableFilteredLabels.length} 个`}
                  </button>
                  <span>·</span>
                  <button
                    type="button"
                ...
                {filteredLabels.map((name) => {
                  ...
                  return (
                    <label
                      ...
                      title={isReserved ? 'latest 由服务端维护，不支持手动设置或取消' : undefined}
                    >
                      <Checkbox
                        checked={isChecked}
                        disabled={isReserved}
