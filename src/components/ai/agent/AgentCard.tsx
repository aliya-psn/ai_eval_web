...
const CAPABILITY_CONFIG = [
  { key: 'streaming' as const, icon: Zap, label: '流式传输', color: 'text-amber-500' },
  { key: 'pushNotifications' as const, icon: Radio, label: '推送通知', color: 'text-blue-500' },
  { key: 'stateTransitionHistory' as const, icon: History, label: '状态历史', color: 'text-emerald-500' },
];
